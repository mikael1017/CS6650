...
public class SwipeApi {
     ...
     */
    public String swipe(SwipeDetails body, String leftorright) throws ApiException {
        ApiResponse<String> resp = swipeWithHttpInfo(body, leftorright);
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> swipeWithHttpInfo(SwipeDetails body, String leftorright) throws ApiException {
